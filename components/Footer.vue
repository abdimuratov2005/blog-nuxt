<template>
    <footer class="footer">
        <div class="fixed-words">
            ...
            &ThinSpace; Remote work &ThinSpace; 
            <strong>
                UX design
            </strong> 
            &ThinSpace; Distributed teams &ThinSpace; 
            <strong>
                Creativity
            </strong> 
            &ThinSpace; Strategy &ThinSpace; 
            <strong>
                Suspense
            </strong>
            &ThinSpace; Growth
        ...
        <div class="footer__container">
            <div class="footer__logo">
                <svg width="397" height="39" viewBox="0 0 397 39" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer__copyright">
                <h4>
                    &copy; 2012-2020 Nordic Rose Co. All rights reserved. 
                </h4>
            </div>
        </div>
    </footer>
...
.footer{
    ...
    &__container{
        ...
        max-width: 488px;
        margin: 0 auto;
        padding: 151px 10px 32px;
        @media (max-width: 767.98px){
            padding: 131px 10px 32px;
        }
        @media (max-width: 574.98px){
            padding: 103px 10px 32px;
        }
    }
    &__logo{
        svg{
    ...
    &__text{
        ...
        margin: 25.5px 0px 32px 0px;
        color: #fff;
        @media (max-width: 767.98px){
            margin: 25.4px 0px 32px 0px;
        }
    }
    &__copyright{ 
        font-weight: 500;
